...
<body class="bg-white dark:bg-slate-950 text-white p-16 space-y-16">
    ...
    <h1 class="text-5xl font-bold text-center">Không tìm thấy kết quả rồi :( </h1>
